...
class GraphHelper {
    ...
    // Http client for getting files from slack server
    private static HttpClient? _httpClient;
    private static readonly Regex GUIDRegex = new(@"\{([^{}]+)\}*");

    private static readonly DriveItemUploadableProperties _uploadSettings = new() {
    ...
    public static void InitializeGraphForUserAuth(Settings settings,
        ...
        _userClient = new GraphServiceClient(_deviceCodeCredential, Settings.SCOPES);
    }
    ...
    public static async Task<string> GetUserTokenAsync() {
        ...
        _ = Settings.SCOPES ?? throw new ArgumentNullException("Argument 'scopes' cannot be null");

        // Request token with given scopes
        var context = new TokenRequestContext(Settings.SCOPES);
